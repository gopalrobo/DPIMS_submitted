...
import com.smart.cst.afimail.master.farmer.MasterFarmerAdapter;
...
public class MasterFGDFragment extends Fragment implements MasterClick {


    private ArrayList<FGDBean> reportTables = new ArrayList<>();


    private RecyclerView mastersList;
    private MasterFGDAdapter mRecyclerAdapterMaster;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRecyclerAdapterMaster = new MasterFGDAdapter(getActivity(), reportTables, this);
        ...
        addActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), CreateFGD.class);
