...
import com.smart.cst.afimail.master.province.CreateProvince;
import com.smart.cst.afimail.master.province.MasterTableAdapter;
...
public class MasterTableFragment extends Fragment implements MasterClick {


    private ArrayList<Province> reportTables = new ArrayList<>();


    private RecyclerView mastersList;
    private MasterTableAdapter mRecyclerAdapterMaster;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRecyclerAdapterMaster = new MasterTableAdapter(getActivity(), reportTables, this);
        ...
        addActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(getActivity(), CreateProvince.class);
    ...
    protected void getReports() {
        ...
        StringRequest req = new StringRequest(Request.Method.GET,
                AppConfig.URL_GET_ALL_PROVINCE,
                        ...
                        try {
                            ...
                            if (success) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Province reportTable = new Province
                                            (object.getString("id"),
                                                    object.getString("ProvinceCode"),
                                                    object.getString("RegionCode"),
                                                    object.getString("ProvinceName"),
                                                    object.getString("ProvinceNameDari"),
                                                    object.getString("ProvinceNamePashtu"));
