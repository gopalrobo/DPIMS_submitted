...
public class CustomFontEditText extends android.support.v7.widget.AppCompatEditText {
    ...
    private void applyCustomFont(final Context context, AttributeSet attrs) {
        ...
        try {
            ...
            if (choices != null && choices.length() > 0 && choices.contains("10,20")) {
                tittle = getHint().toString() + " Percent";
            }
    ...
    public String othersModule(String tittle, final Context context) {
        result = "";
