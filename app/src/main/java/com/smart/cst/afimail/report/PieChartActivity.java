...
public class PieChartActivity extends AppCompatActivity implements SurveyItemClick {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        loadHomeFragment(surveyItems.get(0).question,
    ...
    private void loadHomeFragment(String question, String surveyName, String options,
                                  boolean isYesNo) {
        ...
        for (int i = 0; i < surveyArrayList.size(); i++) {
            ...
            try {
                ...
                if (value != null && value.length() > 0) {
                    ...
                    } else if (surveyName.equals("annualInncom")) {
                        int age = Integer.parseInt(value);
                        if (age >= 0 && age <= 60000) {
                            value = "below 60000";
                        } else if (age >= 60001 && age <= 90000) {
                            value = "60001-90000";
                        } else if (age >= 90001 && age <= 120000) {
                            value = "90001-120000";
                        } else if (age >= 120001 && age <= 150000) {
                            value = "120001-150000";
                        } else if (age >= 150001) {
                            value = "Above 150000";
                        }
                    } else if (surveyName.equals("migratedays")
                            || surveyName.equals("migrateWork")
                            || surveyName.equals("familyMigrat")
                            || surveyName.equals("migratePlace")) {
                        if (value.trim().equals("No")
                                || value.trim().equals("Nno")
                                || value.trim().equals("none")
                                || value.trim().equals("None")
                                || value.trim().equals("Nl")
                                || value.trim().equals("Ni")
                                || value.trim().equals("no")
                                || value.trim().equalsIgnoreCase("Non")
                                || value.trim().equals("No.")
                                || value.trim().equals("Nill")
                                || value.trim().equals("nill")
                                || value.trim().equals("Nil")
                                || value.trim().equals("nil")
                                || value.trim().equals("N8l")
                                || value.trim().equals("n9")
                                || value.trim().equals("NA")
                                || value.trim().equals("Vhu")
                                || value.trim().equals("Na")
                                || value.trim().equals("Not Applicable")
                                || value.trim().equals("Not applicable")
                                || value.trim().equals("Hj")
                                || value.trim().equals("Mo")
                                || value.trim().equals("NoNe")
                                || value.trim().equals("Hh")
                                || value.trim().equals("Nk")
                                || value.trim().equalsIgnoreCase("o")
                                || value.trim().equals("NBI")
                                || value.trim().equals("nio")
                                || value.trim().equals("Nons")
                                || value.trim().equals("Bone")
                                || value.trim().equals("No One")) {
                            value = "No";
                        }
                    } else if (options != null && options.length() > 0) {
                        String[] optionsStrings = options.split(",");
                        if (!stringContainsItemFromList(value, optionsStrings)) {
                            value = "Others";
                        }
                    } else if (isYesNo) {
                        value = "Yes";
