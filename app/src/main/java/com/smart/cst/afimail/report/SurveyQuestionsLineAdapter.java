...
public class SurveyQuestionsLineAdapter extends RecyclerView.Adapter<SurveyQuestionsLineAdapter.MyViewHolder> {
    ...
    public SurveyQuestionsLineAdapter(Context mainActivityUser, ArrayList<SurveyItem> moviesList, SurveyItemClick surveyItemClick) {
