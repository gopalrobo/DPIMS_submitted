...
public class DbAfiMember extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "afiManager";
    private static final int DATABASE_VERSION = 1;
    private static final String KEY_DATA = "data";
    private static final String KEY_PASSWORD = "password";
    private static final String KEY_STUDID = "staffId";
    private static final String TABLE_CONTACTS = "afi";

    public DbAfiMember(Context paramContext) {
    ...
    public void addData(String paramString1, String paramString2) {
        ...
        localSQLiteDatabase.insert(TABLE_CONTACTS, null, localContentValues);
...
//        localSQLiteDatabase.close();
    ...
    public void deletestaffid(String paramString) {
        SQLiteDatabase localSQLiteDatabase = getWritableDatabase();
        localSQLiteDatabase.delete(TABLE_CONTACTS, "staffId = ?", new String[]{paramString});
        localSQLiteDatabase.close();
    }

    public List<ArrayList<String>> getAllData() {
        ArrayList localArrayList1 = new ArrayList();
        Cursor localCursor = getWritableDatabase().rawQuery("SELECT  * FROM "+TABLE_CONTACTS, null);
    ...
    public int getCountBystaffid(String paramString) {
        String str = "SELECT  * FROM afi WHERE staffId='" + paramString + "'";
    ...
    public void onCreate(SQLiteDatabase paramSQLiteDatabase) {
        paramSQLiteDatabase.execSQL("CREATE TABLE afi(staffId TEXT,data TEXT,password TEXT)");
    }

    public void onUpgrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2) {
        paramSQLiteDatabase.execSQL("DROP TABLE IF EXISTS afi");
    ...
    public int updatePassBystaffid(String paramString1, String paramString2) {
        ...
        return localSQLiteDatabase.update(TABLE_CONTACTS, localContentValues, "staffId = ?", new String[]{paramString1});
    }
